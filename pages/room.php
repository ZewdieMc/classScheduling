                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <table id="example1" class="table table-bordered table-striped" style="margin-right:-10px">
                                                    ...
                                                    $query = mysqli_query($con, "select r.room_id,r.room, b.block_number from room r join block b on r.block_id=b.block_id")or die(mysqli_error());
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class=" form-control " name="block"  required>
                                                            <option></option>>
                                                            <?php
                                                            $query2 = mysqli_query($con, "select * from block")or die(mysqli_error($con));
                                                            while ($row = mysqli_fetch_array($query2)) {
                                                                ?>
                                                                <option value="<?php echo $row['block_id'] ?>"><?php echo "Block ".$row['block_number']; ?></option>
                                                            <?php }
                                                            ?>
                                                        </select>
