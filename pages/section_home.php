                                                            ...
                                                            <tr >
                                                                ...
                                                                <td><?php
                                                                    ...
                                                                    if ($count == 0) {
                                                                        ...
                                                                        echo "<br>";
                                                                        echo "$row1[member_last], $row1[member_first]";
                                                                        echo "<br>";
                                                                        echo "Room " . $row1['room'];
                                                                        echo "<br>";
                                                                        echo $row1['remarks'];
                                                                ...
                                                                <td><?php
                                                                    $query1 = mysqli_query($con, "select * from schedule natural join member where day='w' and schedule.member_id='$class' and time_id='$id' and settings_id='$sid'")or die(mysqli_error($con));
