                                                ...
                                                <table class="table table-bordered table-striped" style="margin-right:-10px">
                                                    ...
                                                    while ($row = mysqli_fetch_array($query)) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo $sem; ?></td>
                                                            <td><?php echo $sy; ?></td>
                                                            <td><span class="label label-lg label-<?php echo $flag; ?>"><?php echo $status; ?></span></td>
                                                            <td>
                                                                <a id="removeme" href="activate.php?id=<?php echo $id; ?>">
                                                                    Set<i class="glyphicon glyphicon-ok text-success"></i>&nbsp;</a>
                                                                <a id="removeme" href="settings_del.php?id=<?php echo $id; ?>">
                                                                    Delete<i class="glyphicon glyphicon-trash text-red"></i></a>
                                                            </td>
