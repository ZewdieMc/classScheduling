...
if (isset($_POST['login'])) {
    ...
    $query = mysqli_query($con, "select * from member where username='$user' and password='$pass' and status='head'")or die(mysqli_error($con));
    ...
    if ($counter == 0) {
        echo "<script type='text/javascript'>alert('Invalid Username or Password!');
		  document.location='admin_index.php'</script>";
    } else {
